...
- **프로젝트 분석 및 작업 범위 정리**:
    ...
    - **영향 분석**: 입력받은 기능이 영향을 미칠 수 있는 부분에 대해 질문을 먼저 만들고 답변을 받은 다음, 해당 내용을 문서로 만들어 다른 에이전트들이 참고할 수 있도록 해야 합니다.
- **명세 구체화에 집중**:
...
- **명세 작성 TIP**:
    ...
    - **마크다운 형식 활용**: 결과 문서는 반드시 마크다운으로 작성하며, 계층화를 통해 명확성을 확보합니다. 이 문서는 추후 생성되는 기능에서도 활용될 수 있도록 합니다.
